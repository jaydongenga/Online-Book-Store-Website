...
if(isset($_POST['update_cart'])){
   ...
   $cart_quantity = (int)$_POST['cart_quantity']; // Ensure quantity is an integer
   if($cart_quantity > 0) {
...
if(isset($_GET['delete'])){
   $delete_id = (int)$_GET['delete']; // Ensure delete_id is an integer
...
<section class="shopping-cart">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <a href="cart.php?delete=<?php echo $fetch_cart['id']; ?>" class="fas fa-times" onclick="return confirm('Delete this item from cart?');"></a>
